## hri_actions_msgs (rolling) - 2.5.0-1

The packages in the `hri_actions_msgs` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --new-track --rosdistro rolling --track rolling hri_actions_msgs` on `Wed, 04 Mar 2026 15:14:31 -0000`
